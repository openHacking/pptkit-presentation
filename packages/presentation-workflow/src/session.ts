...
function validateSlidePlan(slide: unknown, index: number, assetIds: ReadonlySet<string>, sourceIds: ReadonlySet<string>) {
  ...
  if (slide.visualIntent !== undefined && (typeof slide.visualIntent !== "string" || !VISUAL_INTENTS.has(slide.visualIntent))) throw new Error(`${path}.visualIntent is unsupported: ${String(slide.visualIntent)}.`);
